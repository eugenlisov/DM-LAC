...
/*
	...
	Text Domain: genesis-bootstrap-carousel
...
define( 'GENESIS_BOOTSTRAP_CAROUSEL_VERSION', '0.1.2' );

register_activation_hook( __FILE__, 'genesis_bootstrap_carousel_activation' );
/**
 ...
 */
function genesis_bootstrap_carousel_activation() {

	if ( !defined('GENESIS_LIB_DIR') ) {
		genesis_bootstrap_carousel_deactivate();
	}
}

/**
 * Deactivates Genesis Bootstrap Carousel
 */
function genesis_bootstrap_carousel_deactivate() {

	deactivate_plugins( plugin_basename( __FILE__ ) );
	wp_die( 'Sorry, you cannot run Genesis Bootstrap Carousel without <a href="http://justintallant.com/go/genesis">Genesis</a>' );
}
...
function genesis_bootstrap_carousel_init() {
	...
	/** require Genesis */
	if ( !defined('GENESIS_LIB_DIR') ) {
		add_action('admin_init', 'genesis_bootstrap_carousel_deactivate');
		return;
	}
...
function genesis_bootstrap_carousel_html5_doctype() {
